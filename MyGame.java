...
public class MyGame extends java.lang.Object implements Game {
	...
	public MyGame() {
		...
		Monster monster1 = new MyMonster("Orc", "covered with green blood", 20, 5, 0);
		Room room1 = new MyRoom(0, "a room with an unbearable smell", monster1);
		Monster monster2 = new MyMonster("Skeleton", "funny how it moves", 40, 10, 10);
		Room room2 = new MyRoom(1, "dark and cold", monster2);
		Monster monster3 = new MyMonster("Fire dragon", "spout fire with each breath", 100, 20, 40);
		Room room3 = new MyRoom(2, "a giant hall with something shiny on the other end", monster3);
		dungeon[0] = room1;
		dungeon[1] = room2;
		dungeon[2] = room3;
	}
